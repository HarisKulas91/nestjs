...
-- CreateIndex
CREATE INDEX "invoice_customer_id_idx" ON "Invoice"("CustomerId");

-- CreateIndex
CREATE INDEX "invoice_line_invoice_id_idx" ON "InvoiceLine"("InvoiceId");

-- CreateIndex
CREATE INDEX "invoice_line_track_id_idx" ON "InvoiceLine"("TrackId");
